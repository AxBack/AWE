...
void ConnectionShader::bindTo(const IMesh& mesh)
{
	...
	glVertexAttribPointer(1, 3, GL_FLOAT, GL_FALSE, sizeof(ConnectionInstance), 0);
	glVertexAttribDivisor(1, 1);

	glEnableVertexAttribArray(2);
	glVertexAttribPointer(2, 3, GL_FLOAT, GL_FALSE, sizeof(ConnectionInstance), BUFFER_OFFSET(12));
	glVertexAttribDivisor(2, 1);

	glEnableVertexAttribArray(3);
	glVertexAttribPointer(3, 1, GL_FLOAT, GL_FALSE, sizeof(ConnectionInstance), BUFFER_OFFSET(24));
